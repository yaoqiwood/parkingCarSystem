...
public class WelcomeController {
	...
	public void imageCode(HttpServletRequest request,HttpServletResponse response) throws IOException {
		ImageUtils imageUtilsNew = new ImageUtils();
		BufferedImage newImage = imageUtilsNew.getImage();
		String code = imageUtilsNew.getText();
		ImageUtils.output(newImage, response.getOutputStream());
	...
	public ModelAndView tableDemo() {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("tableDemo");
		return mv;
	}
	 ...
	 * @return
	 */
	@RequestMapping("/tableDemoSe")
	public ModelAndView tableDemoSe() {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("tableDemoSe");
		return mv;
	}
	 ...
	 * @return
	 */
	@RequestMapping("/amechineLog")
	public ModelAndView amechineLog() {
		ModelAndView mv = new ModelAndView();
		mv.setViewName("amechineLog");
		return mv;
	}
}
