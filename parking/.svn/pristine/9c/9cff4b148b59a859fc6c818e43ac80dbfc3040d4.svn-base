...
public interface CarServiceMapper {
	 ...
	 * 查车服务的详细信息
	 * @param ser_id 服务id
	 * @return CarServiceDto对象
	 */
	CarServiceDto selectCarServiceDto(@Param("ser_id") String ser_id);
	 ...
	 * @return CarServiceDto对象
	 */
	CarServiceDto selectCarServiceUsing(@Param("carNum") String carNum);
	
	/**
	 * 查出即将到期的时间
	 * @return CarServiceDto对象
	 */
	CarServiceDto expireCarService();
}
