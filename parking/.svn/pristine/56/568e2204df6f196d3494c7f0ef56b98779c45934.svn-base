...
public class CarInServiceImpl implements CarInService{
	...
	@Autowired
	private CarnumMapper mappercar;
	
	@Autowired
	private WhiteListMapper mapperwhite;
	
	@Autowired
	private PlaceMapper mapperPlace;
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public Integer addCarnum(Carnum carnum) {
		// TODO Auto-generated method stub
		Integer addCarnum = mapper.addCarnum(carnum);
		return addCarnum;
	}
	...
	@Transactional(rollbackFor = Exception.class)
	@Override
	public Integer updatePlaceState(String carNum ,String number) {
		// TODO Auto-generated method stub
		Integer updatePlaceState = mapper.updatePlaceState(carNum,number);
	...
	public Integer addcarRecord(String carNumId, String startTime) {
		// TODO Auto-generated method stub
		Integer addcarRecord = mappercar.addcarRecord(carNumId, startTime);
		return addcarRecord;
	}

	@Override
	public WhiteList whiteListInfo(String carnum) {
		// TODO Auto-generated method stub
		WhiteList whiteListInfo = mapperwhite.whiteListInfo(carnum);
		return whiteListInfo;
	}

	@Override
	public Place placeInfo(String carnum) {
		// TODO Auto-generated method stub
		Place placeInfo = mapperPlace.placeInfo(carnum);
		return placeInfo;
	}
}
