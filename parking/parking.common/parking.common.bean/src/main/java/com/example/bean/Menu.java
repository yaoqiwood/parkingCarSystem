...
public class Menu {
	...
	public Menu(Integer menuId, Integer menuParent, String menuName, String menuUrl, Integer menuState, String menuMemo,
			Date menuCreateTime, Date menuUpdateTime) {
		super();
		this.menuId = menuId;
	...
	public String toString() {
		return "Menu [menuId=" + menuId + ", menuParent=" + menuParent + ", menuName=" + menuName + ", menuUrl="
