...
public class CarServiceServiceImpl implements CarServiceService{
	...
	/* (non-Javadoc)
	 * @see com.example.service.CarServiceService#selectCarServiceDto(java.lang.String)
	 */
	@Override
	public CarServiceDto selectCarServiceDto(String ser_id) {
		// TODO Auto-generated method stub
		CarServiceDto carServiceDto = carServiceMapper.selectCarServiceDto(ser_id);
		return carServiceDto;
	}

	/* (non-Javadoc)
	 * @see com.example.service.CarServiceService#selectCarServiceUsing(java.lang.String)
	 */
	@Override
	public CarServiceDto selectCarServiceUsing(String carNum) {
		// TODO Auto-generated method stub
		CarServiceDto carServiceDto = carServiceMapper.selectCarServiceUsing(carNum);
		return carServiceDto;
	}
