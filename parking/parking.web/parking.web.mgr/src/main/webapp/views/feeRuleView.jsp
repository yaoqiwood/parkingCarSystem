...
<body>
    <div class="col-xs-12 no-padding panel panel-primary container-fluid">
        <div class="panel-heading center">
            	<i class="icon icon-folder-close"></i>&nbsp;计费规则
        </div>

        <div class="panel-body container-fluid ">
            <div class="row">
                <div class="col-xs-12 col-sm-6 col-md-8 scan">
                    <div class="input-group">
                        <span class="input-group-addon">金额</span>
                        <input type="text" id="ruleMoney" class="form-control" />
                    </div>
                </div>
                <div class="col-xs-6 col-sm-3 col-md-2 scan">
            ...
            <div class="addPanelBox" >
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body input-group">
                        ...
                        <input type="text" id="addTimeLapS" disabled class="form-control" value="" >
                        <span class="input-group-addon">至</span>
                        <input type="text" id="addTimeLapE"  class="form-control" value="" >
                    </div>
                    <div class="panel-body input-group">
                        <span class="input-group-addon">收费金额</span>
                        <input type="text" class="form-control" id="ruleHourMoney" >
                    </div>
        ...
        <div class = "backWhite" id="updatePanelBox">
            <div class="updatePanelBox">
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body input-group">
                        <span class="input-group-addon">小时累计</span>
                        <input type="text" id="upTimeLapS" disabled class="form-control" value="" >
                        <span class="input-group-addon">至</span>
                        <input type="text" id="upTimeLapE"  class="form-control" value="" >
                    </div>
                    <div class="panel-body input-group">
                        <span class="input-group-addon">收费金额</span>
                        <input type="text" class="form-control" id="upRuleMoney" >
                    </div>
                    <div class="center bottomSpace">
