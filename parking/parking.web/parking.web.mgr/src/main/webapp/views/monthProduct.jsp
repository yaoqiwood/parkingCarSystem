...
<body>
	<div class="col-xs-12 no-padding panel panel-primary container-fluid">
		<div class="panel-heading center">
			<i class="icon-th-list"></i>&nbsp;月缴产品管理
		</div>

		<div class="panel-body container-fluid ">
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-6 scan">
				...
				<div class="col-xs-12 col-sm-8 col-md-4 scan">
					<div class="input-group">
						<span class="input-group-addon">产品名</span> <input type="text" id="proName" class="form-control">
					</div>
				</div>
