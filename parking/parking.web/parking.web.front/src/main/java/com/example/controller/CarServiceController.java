...
public class CarServiceController {
	...
	public JSONObject checkCarNum(String carNum, HttpServletRequest request) {
		...
		if (carnum != null) {
			...
			carnumService.addCarnum(carNum);
			carnum = carnumService.checkCarnum(carNum);
		}
		data.put("type", 1);
		return data;
	}
	...
	public JSONObject buyMonthProduct(String addId, String addName, String addMoney, HttpServletRequest request) {
		...
		AdminAmountLog adminAmountLog = new AdminAmountLog(null, 1, carNum, money, "购买" + addName + "产品", null, null, null);
		...
		if (flag <= 0) {
			...
			carnumService.updateCarnumRole(carNum, "2");
		}
		return data;
	}
