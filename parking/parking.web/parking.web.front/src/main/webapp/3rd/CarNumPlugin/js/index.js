...
window.onload = function() {
	...
	$(".input_pro").click(function(){
		 layer.open({
			...
			,shade :false 
<<<<<<< .mine
			,style: 'position:fixed; bottom:0; left:0; width: 100%; height: auto; padding:0; border:none;margin-bottom:39px;'
||||||| .r220
			,style: 'position:fixed; bottom:0; left:0; width: 100%; height: auto; padding:0; border:none;'
=======
			,style: 'position:fixed; bottom:0; left:0; width: 100%; height: auto; padding:0; border:none;margin-bottom:87px;'
>>>>>>> .r223
		  });
		 showProvince()
	})
